...
| 属性名             | 类型             | 绑到什么                        |
| --------------- | -------------- | --------------------------- |
| `castlePlayer`  | `Castle`       | Castle\_Player 节点           |
| `castleEnemy`   | `Castle`       | Castle\_Enemy 节点            |
...
| `unitButtons`   | `Button[]` | \[UnitButton\_0, UnitButton\_1]   |
...
* [ ] LSP 诊断无 error（war\_evolution 目录下所有文件）
